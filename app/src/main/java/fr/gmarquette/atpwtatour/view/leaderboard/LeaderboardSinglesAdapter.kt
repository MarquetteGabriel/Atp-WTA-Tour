...
class LeaderboardSinglesAdapter(private val playerList: List<Profile>, private var context: Context,
                                private val clickListener: (Profile) -> Unit) : RecyclerView.Adapter<LeaderboardSinglesAdapter.ViewHolder>()
{
