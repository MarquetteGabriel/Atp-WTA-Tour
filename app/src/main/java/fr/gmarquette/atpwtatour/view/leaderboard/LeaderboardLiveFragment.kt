...
import fr.gmarquette.atpwtatour.databinding.FragmentLeaderboardLiveBinding
...
class LeaderboardLiveFragment: Fragment()
{
    ...
    private lateinit var binding: FragmentLeaderboardLiveBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_leaderboard_live, container, false)
        ...
        tempList.sortBy { it.rank.liveRank }
        val recyclerView: RecyclerView = view.findViewById(R.id.leaderboardRecyclerView)
        recyclerView.setHasFixedSize(true)
        recyclerView.layoutManager = LinearLayoutManager(this.context, RecyclerView.VERTICAL, false)
        recyclerView.adapter = LeaderboardLiveAdapter(tempList, requireContext()) {
