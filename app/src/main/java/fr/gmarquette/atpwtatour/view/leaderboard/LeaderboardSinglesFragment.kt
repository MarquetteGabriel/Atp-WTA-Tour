...
import fr.gmarquette.atpwtatour.databinding.FragmentLeaderboardSinglesBinding
...
class LeaderboardSinglesFragment: Fragment()
{
    private lateinit var profileViewModel: ProfileViewModel
    private lateinit var binding: FragmentLeaderboardSinglesBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_leaderboard_singles, container, false)
        ...
        recyclerView.adapter = LeaderboardSinglesAdapter(tempList, requireContext()) {
